...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <ButtonLayout>
      {allow ? (
        <StyledButtonComponent buttonStyle="black" onClick={handleSubmit}>
          show
        </StyledButtonComponent>
      ) : (
        <StyledButtonComponent buttonStyle="black" onClick={handleEdit}>
          Edit
        </StyledButtonComponent>
      )}
      <StyledButtonComponent buttonStyle="black" onClick={handleCancel}>
        Cancel
      </StyledButtonComponent>
    </ButtonLayout>
  );
